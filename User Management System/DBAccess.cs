...
namespace User_Management_System
{
    internal class DBAccess
    {
        ...
        private static string strConnString = @"Data Source=DESKTOP-ENIT3AG\\SQLEXPRESS;Initial Catalog=user_management_system;Integrated Security=True;TrustServerCertificate=True";
